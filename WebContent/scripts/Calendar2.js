...
var bMoveable=true;
var strFrame;		
document.writeln('<iframe id=endDateLayer frameborder=0 style="position: fixed; z-index: 9998; display: none"></iframe>');
strFrame='<style>';
...
strFrame+='</scr' + 'ipt>';
strFrame+='<div style="z-index:9999;position: fixed; left:0; top:0;" onselectstart="return false">';
strFrame+='<span id=tmpSelectYearLayer  style="z-index: 9999;position: fixed;top: 3; left: 19;display: none"></span>';
strFrame+='<span id=tmpSelectMonthLayer  style="z-index: 9999;position: fixed;top: 3; left: 78;display: none"></span>';
strFrame+='<span id=tmpSelectHourLayer  style="z-index: 9999;position: fixed;top: 188; left: 56;display: none"></span>';
strFrame+='<span id=tmpSelectMinuteLayer style="z-index:9999;position:fixed;top: 188; left: 107;display: none"></span>';
...
var meizzWDay=new Array(37);               //定义写日期的数组
 ...
 window.document.onclick() //任意点击时关闭该控件	//ie6的情况可以由下面的切换焦点处理代替
{ 
  with(window.event)
 ...
 window.document.onkeyup()		//按Esc键关闭，切换焦点关闭
  {
