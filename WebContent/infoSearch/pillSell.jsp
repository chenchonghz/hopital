...
function searchPill(){
    var pillname=document.getElementById("pillname").value;
     ...
     var url="pillSellpillSearch?seachText="+pillname;
     if(req){
...
function find(){
	     ...
	     var pillNum = document.getElementsByName("pillNum");   
         var val1=null;   
         for(var i=0;i<pillNum.length;i++)   
         {   
         if (pillNum[i].checked)   
         {  
        	 val1=pillNum[i].value; break;    }    
         } 
     ...
     var url="pillSellSearch?startDay="+startDay+"&endDay="+endDay+"&pillId="+val1+"&docId="+val2;
     if(req){
         //调用XMLHttpRequest的open方法
         req.open("get",url,true);
...
<div id="yp">&nbsp&nbsp
   ...
   <input type="button" value="按名称查找药品" class="btn blue" onclick="searchPill()" style="margin:0;">
   <!-- <input type="radio" name="pillNum" value="10001" />头孢
      <input type="radio" name="pillNum" value="10002" />安定  -->
</div>
<br><br>
