...
<script type="text/javascript">
    ...
    function search(){
        var anything=document.getElementById("seachText").value;
         var url="searchP?seachText="+anything;
         if(req){
             //调用XMLHttpRequest的open方法
             req.open("get",url,true);
...
out.print(com.patientSearch());%>
		  <!--   
			<tr>
				<td><a href="patientDetail.jsp?patientId=201306061">201306061</a></td>
				<td>qiuye</td>
				<td>2013-06-06</td>
				<td><input type="button" value="删除" onclick="dele(201306072)"></td>
			</tr>-->
		 </tbody>
	</table>
	</div>
