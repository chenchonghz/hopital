...
function search(){
    ...
    var anything=document.getElementById("seachText").value;
     var url="searchE?seachText="+anything;
...
out.print(com.equipSearch( Integer.parseInt(session.getAttribute("authority").toString())));%>
<!--  
			<tr>
				<td>3001</td>
				<td><a href="equipDetail.jsp?patientId=201306061">CT检查机</a></td>
				<td>2013-06-06</td>
				<td>N</td>
				<td><input type="button" value="删除" id="1" onclick="dele(3001)"></td>
			</tr>
			-->
		 </tbody>
	</table>
